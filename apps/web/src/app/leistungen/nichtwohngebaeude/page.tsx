...
const categorySlug = "nichtwohngebaeude";
...
const DEFAULT_TITLE = "Leistungen für Nichtwohngebäude";
const DEFAULT_DESCRIPTION =
  "Ganzheitliche Energieberatung, DIN V 18599 Nachweise und Energieaudits für Gewerbe, Industrie und öffentliche Gebäude.";
...
export default async function NichtwohngebaeudePage() {
  const { data: category } = await fetchCategoryData();
    ...
    <main className="space-y-12 py-12">
      ...
      {hasBlocks ? (
        ...
        <section className="mx-auto max-w-6xl">
          <ServiceListSection
            _type="serviceList"
            _key="nichtwohngebaeude-fallback"
            presetAudience={["nwg"]}
