...
const categorySlug = "wohngebaeude";
...
const DEFAULT_TITLE = "Leistungen für Wohngebäude";
const DEFAULT_DESCRIPTION =
  "Energieberatung, Sanierungsfahrplan (iSFP) und Fördermittel für Wohngebäude.";
...
export default async function WohngebaeudePage() {
  const { data: category } = await fetchCategoryData();
